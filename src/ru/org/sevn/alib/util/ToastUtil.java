...
public class ToastUtil {
    ...
    public static void rtoast(final Context ctx, final String s, final int length) {
    ...
    public static void rtoastLong(final Context ctx, final String s) {
        rtoast(ctx, s, Toast.LENGTH_LONG);
    }
    public static void rtoastShort(final Context ctx, final String s) {
        rtoast(ctx, s, Toast.LENGTH_SHORT);
    }
}
